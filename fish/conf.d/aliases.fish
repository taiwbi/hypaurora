...
alias cc 'claude'
alias cx 'codex'
alias oc 'OPENCODE_ENABLE_EXA=1 OPENCODE_TUI_CONFIG=~/.config/opencode/tui.json opencode'
alias cl clear
alias cd.. 'cd ..'
alias .. 'cd ..'
alias ... 'cd ../..'
...
# IP Aliases
alias myip 'curl --silent "https://api.ipinfo.io/lite/me?token=$(cat $HOME/.keys/IPINFO)"'
