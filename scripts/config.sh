...
gsettings set org.gnome.desktop.interface font-name 'Iosevka Aile, Dana 11'
gsettings set org.gnome.desktop.interface monospace-font-name 'Iosevka, AzarMehrMonospaced 11'
