...
gsettings set org.gnome.desktop.interface font-name 'DM Sans 11'
gsettings set org.gnome.desktop.interface monospace-font-name 'DM Mono, Vazir Code Hack 11'
