...
gsettings set org.gnome.desktop.interface font-name 'Mona Sans VF, Vazirmatn 11'
gsettings set org.gnome.desktop.interface monospace-font-name 'Monaspace Argon Var, Vazir Code Hack 11'
