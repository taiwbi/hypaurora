...
gsettings set org.gnome.desktop.interface monospace-font-name 'Iosevka, Vazir Code Hack, Symbols Nerd Font 12'
...
gsettings set org.gnome.settings-daemon.plugins.media-keys.custom-keybinding:/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/custom1/ command "$HOME/Documents/hypaurora/code/nvim.sh"
