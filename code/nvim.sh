...
export PATH="$HOME/.local/bin:$HOME/.local/npm/bin:$HOME/.cargo/bin:$HOME/.config/composer/vendor/bin:$HOME/.npm-global/bin:$PATH"
...
if [[ "$1" == "kitty" ]]; then
    ...
    "neovide" --wayland_app_id "neovide" --neovim-bin "nvim"
fi
